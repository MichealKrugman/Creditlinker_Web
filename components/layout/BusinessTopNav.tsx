...
import {
  ...
  BarChart2, Bell as BellIcon, Scale,
} from 'lucide-react';
...
const MENU_ITEMS = [
  { label: 'Business Profile', href: '/business-profile', icon: <Building2 size={13} /> },
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        >
          ...
          <span style={{
            ...
            background: '#00D4FF', border: '1.5px solid white',
          }} />
        </Link>
          ...
          {open && (
            <div style={{
              ...
              <div style={{ padding: '14px 16px', borderBottom: '1px solid #F3F4F6' }}>
                ...
                <p style={{ fontSize: 12, color: '#9CA3AF' }}>ada@adukebakeries.ng</p>
                <p style={{ fontSize: 11, color: '#9CA3AF', marginTop: 4 }}>
                  Aduke Bakeries Ltd. · Business account
                </p>
              </div>
