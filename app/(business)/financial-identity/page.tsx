...
/* ─────────────────────────────────────────────────────────
   MOCK DATA
   Replace with: GET /business/score
                 GET /business/profile
                 GET /business/snapshots
───────────────────────────────────────────────────────── */
const IDENTITY = {
  ...
  dimensions: [
    {
      ...
      max: 100,
      color: "#10B981",
      description: "Consistency and predictability of revenue inflows over 24 months.",
      trend: "+4 since last run",
      positive: true,
    },
    {
      key: "cashflow_predictability",
      label: "Cashflow Predictability",
      value: 78,
      max: 100,
      color: "#38BDF8",
      description: "Reliability of positive operating cashflow generation.",
    ...
    },
    {
      ...
      max: 100,
      color: "#818CF8",
      description: "Operating cost control relative to revenue.",
      trend: "No change",
      positive: null,
    },
    {
      key: "liquidity_strength",
      label: "Liquidity Strength",
      value: 74,
      max: 100,
      color: "#F59E0B",
      description: "Cash reserves and financial buffers available to the business.",
      trend: "-3 since last run",
      positive: false,
    },
    {
      key: "financial_consistency",
      label: "Financial Consistency",
      value: 80,
      max: 100,
      color: "#10B981",
      description: "Completeness and regularity of financial activity and reporting.",
      trend: "+1 since last run",
      positive: true,
    },
    {
      key: "risk_profile",
      ...
      max: 100,
      color: "#EF4444",
      description: "Anomalies, irregular behaviour, and risk signals in financial activity.",
      trend: "+6 since last run",
      positive: true,
    },
  ],
};
...
const RISK_FLAGS = [
  {
    ...
    severity: "medium",
    description: "Over 60% of revenue from a single counterparty cluster.",
    score_impact: -8,
  },
];
...
function ScoreRingLarge({ score, max = 1000 }: { score: number; max?: number }) {
  ...
  return (
    <svg width="160" height="160" viewBox="0 0 160 160">
      ...
      <circle
        cx="80" cy="80" r={r}
        fill="none" stroke="#00D4FF" strokeWidth="10"
        strokeLinecap="round"
        strokeDasharray={`${dash} ${circ}`}
        strokeDashoffset={circ * 0.25}
        transform="rotate(-90 80 80)"
      />
      <text x="80" y="74" textAnchor="middle" fontSize="32" fontWeight="800"
        fill="#0A2540" fontFamily="var(--font-display)" letterSpacing="-2">
        {score}
      </text>
      <text x="80" y="91" textAnchor="middle" fontSize="11" fontWeight="600"
        fill="#9CA3AF" fontFamily="var(--font-display)">
        out of {max.toLocaleString()}
      </text>
      <text x="80" y="108" textAnchor="middle" fontSize="11" fontWeight="700"
        fill="#10B981" fontFamily="var(--font-display)" letterSpacing="0.3">
        LOW RISK
      </text>
    </svg>
  );
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 12 }}>
        ...
        <span style={{ fontSize: 20, fontWeight: 800, color: d.color, fontFamily: "var(--font-display)", letterSpacing: "-0.04em" }}>
          {d.value}
        </span>
      </div>
      ...
      <div style={{ height: 6, borderRadius: 9999, background: "#F3F4F6", marginBottom: 12, overflow: "hidden" }}>
        <div style={{
          ...
          background: d.color, borderRadius: 9999,
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
        <TrendingUp size={11} style={{
          color: d.positive === true ? "#10B981" : d.positive === false ? "#EF4444" : "#9CA3AF",
        }} />
        <span style={{
          ...
          <div style={{ background: "white", border: "1px solid #E5E7EB", borderRadius: 12, overflow: "hidden" }}>
            ...
            <div style={{ padding: "16px 20px" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", marginTop: 14, paddingTop: 12, borderTop: "1px solid #F3F4F6" }}>
                ...
                <span style={{ fontSize: 11, color: "#9CA3AF" }}>ID: <span style={{ fontFamily: "monospace", color: "#6B7280" }}>{IDENTITY.financial_identity_id}</span></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "flex", gap: 8, padding: "10px 14px", background: "rgba(0,212,255,0.04)", border: "1px solid rgba(0,212,255,0.15)", borderRadius: 9 }}>
            ...
            <p style={{ fontSize: 12, color: "#0A5060", lineHeight: 1.6 }}>
              Sharing this link gives anyone a <strong>read-only preview</strong>. Full data access still requires explicit consent from you on the Financers page.
            </p>
          </div>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                border: "none",
                background: copied ? "#10B981" : "#0A2540",
          ...
          {/* Manage consent CTA */}
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={onClose} style={{ flex: 1, height: 40, borderRadius: 8, border: "1px solid #E5E7EB", background: "white", fontSize: 13, fontWeight: 600, color: "#6B7280", cursor: "pointer" }}>
              Close
            </button>
            <Link
              href="/financers"
  ...
  return (
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              ...
              <Badge variant={status.variant} style={{ display: "flex", alignItems: "center", gap: 4 }}>
                {status.icon} {status.label}
              </Badge>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
              <span style={{ fontSize: 12, color: "#9CA3AF" }}>
                ID: <span style={{ fontFamily: "monospace", color: "#6B7280" }}>{IDENTITY.financial_identity_id}</span>
              </span>
              <span style={{ color: "#E5E7EB" }}>·</span>
              <span style={{ fontSize: 12, color: "#9CA3AF" }}>
                Coverage: <span style={{ color: "#6B7280", fontWeight: 500 }}>{IDENTITY.data_coverage}</span>
              </span>
              <span style={{ color: "#E5E7EB" }}>·</span>
              <span style={{ fontSize: 12, color: "#9CA3AF" }}>
                Last run: <span style={{ color: "#6B7280", fontWeight: 500 }}>{IDENTITY.last_pipeline_run}</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <Button variant="outline" size="sm" style={{ gap: 6 }}
            onClick={() => {
              // TODO: POST /business/runPipeline
      ...
      <div style={{
          ...
          <Card style={{ padding: "24px 20px", textAlign: "center" }}>
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{ fontSize: 20, fontWeight: 800, color: "#0A2540", fontFamily: "var(--font-display)", letterSpacing: "-0.03em" }}>
                ...
                <div key={item.label}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                    ...
                    <span style={{
                      ...
                      color: item.pct === 100 ? "#10B981" : "#F59E0B",
                    }}>
                      {item.pct}%
                    </span>
                  </div>
              ...
              {LINKED_ACCOUNTS.map((acc, i) => (
                <div key={i} style={{
                  ...
                  <div style={{
                    ...
                    display: "flex", alignItems: "center", justifyContent: "center",
                    fontSize: 10, fontWeight: 800, color: "#0A2540",
                  }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
                      ...
                      {acc.primary && (
                        <Badge variant="secondary" style={{ fontSize: 9, padding: "1px 5px" }}>Primary</Badge>
                      )}
                    </div>
        ...
        {/* ── RIGHT: DIMENSIONS + FLAGS + HISTORY ── */}
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
              <div>
                ...
                <p style={{ fontSize: 12, color: "#9CA3AF" }}>
                  Six independent financial health indicators, each scored 0–100.
                </p>
              </div>
          ...
          {RISK_FLAGS.length > 0 && (
            <Card>
              <SectionHeader
                title="Risk Flags"
                sub={`${RISK_FLAGS.length} active flag${RISK_FLAGS.length > 1 ? "s" : ""} detected`}
              />
              <div style={{ padding: "12px 24px 20px", display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: 8, marginTop: 4 }}>
                  ...
                  <p style={{ fontSize: 12, color: "#9CA3AF", lineHeight: 1.5 }}>
                    Risk flags are recalculated on every pipeline run. Resolving them will improve your score.
                  </p>
                </div>
              </div>
            </Card>
          ...
          <Card>
            <SectionHeader
              ...
              sub="Snapshots taken after each pipeline run."
            />
            <div style={{ padding: "10px 0 8px" }}>
              {/* Header row */}
              <div style={{
              ...
              {SNAPSHOTS.map((snap, i) => (
                <div key={i} style={{
                  display: "grid", gridTemplateColumns: "1fr 80px 100px 80px",
                  padding: "12px 24px",
                  borderBottom: i < SNAPSHOTS.length - 1 ? "1px solid #F3F4F6" : "none",
                  alignItems: "center",
                }}>
                  ...
                  <Badge variant={
                    snap.risk === "Low Risk" ? "success" :
                    snap.risk === "Medium Risk" ? "warning" : "destructive"
            ...
            <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
              ...
              <div>
                <p style={{
                  ...
                  Ready to connect with capital providers?
                </p>
                <p style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", lineHeight: 1.5 }}>
                  Share your financial identity with financers you trust — on your terms.
                </p>
              </div>
            </div>
